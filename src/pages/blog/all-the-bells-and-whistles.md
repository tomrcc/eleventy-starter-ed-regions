...
{% include 'components/snippets/alert/alert' background_color: "#FF785A" alert_message: "Test test test" color: "#FEF9EF" icon: "fa-solid fa-bell" %}
...
{% include 'components/snippets/alert/alert' background_color: "#034AD8" alert_message: "This is an alert message" color: "#000000" icon: "fa-solid fa-bell" %}

{% include 'components/snippets/file/file' src: "/assets/documents/test.pdf" file_name: "test-file" link_message: "A test file to show how you'd have a downloadable link through your markdown" %}

Some text which is normal color - {% tint, "#F7B2AD" %}Woah a tint!{% endtint %} Some more text to show how inline tint is.

{% include 'components/snippets/video/video' src: "/assets/videos/test.mp4" %}